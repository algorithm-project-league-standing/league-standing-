...
The time complexity of this program is `O(E log V)`, where V is the number of teams and E is the total number of matches played. This complexity comes from the following steps:
